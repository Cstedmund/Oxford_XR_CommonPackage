...
public class BoneController : MonoBehaviour {
    ...
    //public List<string> JointIndicesList = new List<string>() {
    //    "Invalid",
    //    "Root",
    //    "Hips",
    //    "LeftUpLeg",
    ...
    public void ApplyBodyPose(ARHumanBody body) {
        ...
        for(int i = 0; i < k_NumSkeletonJoints; ++i) {
            ...
            if(bone != null) {
                ...
                Quaternion.Euler(new Vector3(joint.localPose.rotation.eulerAngles.x % 360,
                    joint.localPose.rotation.eulerAngles.y % 360,
                    joint.localPose.rotation.eulerAngles.z % 360));
